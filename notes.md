...
$grp="parakram-22-May2"
$location1="centralindia" 
$vnetName1="parakram-vnet2" 
$subnetName="Subnet1"
$vmName="parakram-vm2"
...
az vm create --resource-group $grp --name $vmName --image Win2019Datacenter --vnet-name $vnetName1 --subnet $subnetName --admin-username parakram --admin-password Hello@12345# --size Standard_B1s
